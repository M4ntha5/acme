...
public class SendPhoneMessageNotificationToUsersWhoSubscriptionEndingSoon(ApplicationDbContext applicationDbContext, IPhoneMessagesSender phoneMessagesSender, ILogger<SendPhoneMessageNotificationToUsersWhoSubscriptionEndingSoon> logger) 
    : BackgroundJob(logger)
{
