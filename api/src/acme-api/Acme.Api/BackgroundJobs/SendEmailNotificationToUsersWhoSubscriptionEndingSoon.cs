...
public class SendEmailNotificationToUsersWhoSubscriptionEndingSoon(ApplicationDbContext applicationDbContext, IEmailsSender emailsSender, ILogger<SendEmailNotificationToUsersWhoSubscriptionEndingSoon> logger) 
