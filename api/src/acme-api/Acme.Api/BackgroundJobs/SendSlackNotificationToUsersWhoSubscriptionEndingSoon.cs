...
public class SendSlackNotificationToUsersWhoSubscriptionEndingSoon(ApplicationDbContext applicationDbContext, ISlackNotificationSender slackNotificationSender, ILogger<SendSlackNotificationToUsersWhoSubscriptionEndingSoon> logger) 
